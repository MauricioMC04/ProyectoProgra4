...
public class ventanaFacturaAdministrador_1 extends javax.swing.JFrame {
    ...
    public ventanaFacturaAdministrador_1() {
        initComponents();
        ...
        this.setVenta(clases.main.V.getVA().getVenta());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaFacturaAdministrador_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaFacturaAdministrador_1().setVisible(true);
            }
        });
    }
