 ...
 * @author dannycolumna
 */
public class DetalleDeFacturaAdministrador extends javax.swing.JFrame {
    ...
    public DetalleDeFacturaAdministrador() {
        initComponents();
    ...
    private void btnEliminarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarProductoActionPerformed
        ...
        try {
            ...
            clases.main.V.getVA().setProceso(proceso);
            this.MostrarProductos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleDeFacturaAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetalleDeFacturaAdministrador().setVisible(true);
            }
        });
    }
