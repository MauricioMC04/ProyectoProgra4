...
public class ventanaFacturaAdministrador extends javax.swing.JFrame {
    ...
    public ventanaFacturaAdministrador() {
        initComponents();
        ...
        this.setProceso(clases.main.V.getVA().getProceso());
    ...
    private void MostrarPrecio(){
        String precio = Integer.toString(this.getProceso().PrecioTotal());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaFacturaAdministrador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaFacturaAdministrador().setVisible(true);
            }
        });
    }
